...
def filtrar_usuario(cpf, usuarios):
    #usuarios_filtrados = next((usuario for usuario in usuarios if usuario == cpf), None)
...
def criar_conta(agencia, usuarios, contas):
    ...
    if usuario:
        ...
        contas[numero_conta] = {"agencia": agencia, "senha": senha, "usuario": usuario, "limite_numero_saques": limite_numero_saques,
                                "numero_saques": numero_saques, "saldo": saldo, "limite_saque": limite_saque, "extrato": extrato}
        print("\n=== Conta criada com sucesso! ===")
    else:
        print("\n@@@ Usuário não encontrado, fluxo de criação de conta encerrado! @@@")
def filtrar_contas(codigo, contas):
    #contas_filtradas = next((conta for conta in contas if conta == codigo), None)
