...
class Cliente(Pessoa):
    ...
    def criar_contabasica(self, senha, limite=500, limite_saques=3) -> 'ContaBasica':
        conta = ContaBasica(self, senha, limite=limite, limite_saques=limite_saques)
        self.contas.adicionar(conta)
        print(f"=== Conta de número {conta.codigo} criada com sucesso! ===")
        return conta
...
class Pessoas(Lista):
    ...
    def tornar_cliente(self, pessoa: Pessoa) -> Cliente:
        if not isinstance(pessoa, Pessoa):
            raise TypeError("O objeto deve ser uma instância de Pessoa.")
        novo_cliente = Cliente(pessoa.cpf, pessoa.nome, pessoa.data_nascimento, pessoa.endereco)
        self.registros[pessoa.cpf] = novo_cliente
        Pessoas._regs_cls[pessoa.cpf] = novo_cliente
        self.clientes[pessoa.cpf] = novo_cliente
        Clientes._regs_cls[pessoa.cpf] = novo_cliente
        return novo_cliente
...
gp1 = Pessoas()
gp2 = Pessoas()
gp1.adicionar(Pessoa(cpf='0', nome='Joao', data_nascimento='01/01/1990', endereco='end1'))
gp2.adicionar(gp1['0'])
print('gp1[0]:', gp1['0'].__class__.__name__) # gp1[0]: Pessoa
print('gp2[0]:', gp2['0'].__class__.__name__) # gp2[0]: Pessoa
gp1.tornar_cliente(gp1['0'])
print('gp1[0]:', gp1['0'].__class__.__name__) # gp1[0]: Cliente
print('gp2[0]:', gp2['0'].__class__.__name__) # gp2[0]: Pessoa

gp1.adicionar(Pessoa(cpf='0', nome='Nome 0', data_nascimento='01/01/1990', endereco='end1'))
gp1.adicionar(Pessoa(cpf='1', nome='Nome 1', data_nascimento='01/01/1990', endereco='end1'))
gp1.adicionar(Pessoa(cpf='2', nome='Nome 2', data_nascimento='01/01/1990', endereco='end1'))
gp1.adicionar(Pessoa(cpf='3', nome='Nome 3', data_nascimento='01/01/1990', endereco='end1'))
gp1.adicionar(Pessoa(cpf='4', nome='Nome 4', data_nascimento='01/01/1990', endereco='end1'))
gp1.adicionar(Pessoa(cpf='5', nome='Nome 5', data_nascimento='01/01/1990', endereco='end1'))
for pessoa in gp1:
    gp1.tornar_cliente(pessoa)
contas = Contas()
contas.adicionar(gp1.clientes['3'].criar_conta(senha='abc'))
contas.adicionar(gp1.clientes['2'].criar_contabasica(senha='abc'))
gp1.clientes['2'].contas[1].depositar(1000)
gp1.clientes['2'].contas[1].sacar(150)
gp1.clientes['2'].contas[1].sacar(150)
gp1.clientes['2'].contas[1].sacar(150)
gp1.clientes['2'].contas[1].sacar(150)
gp1.clientes['2'].contas[1].exibir_extrato()
gp1.clientes['3'].contas[0].depositar(1000)
gp1.clientes['3'].contas[0].sacar(150)
gp1.clientes['3'].contas[0].sacar(150)
gp1.clientes['3'].contas[0].sacar(150)
gp1.clientes['3'].contas[0].sacar(150)
gp1.clientes['3'].contas[0].exibir_extrato()
...
print(f'\n\n\n\n')
interface = Interface(gp1,contas)
